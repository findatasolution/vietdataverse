(function(){
  ...
  var mobileNavHTML = '<nav class="docs-mobile-nav">'
    ...
    + '<a href="/index.html#legal/about">Điều khoản</a>'
    + '</nav>';
  ...
  var NAV = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: 'developer.html', label: 'API Keys &amp; Auth', icon: '<svg class="docs-nav-item-icon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/></svg>' },
    ...
    },
    {
      title: 'Pháp lý',
      items: [
        { href: '/index.html#legal/about', label: 'Điều khoản dịch vụ', icon: '<svg class="docs-nav-item-icon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>' },
        { href: '/index.html#legal/privacy', label: 'Chính sách bảo mật', icon: '<svg class="docs-nav-item-icon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>' },
