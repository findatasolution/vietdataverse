"""
Referral system — link giới thiệu cho tài khoản Pro Data.
...
async def get_my_referral_code(request: Request):
    """
    Trả về referral code và URL cho tài khoản Pro Data.
    ...
    if user.get("user_level") not in ELIGIBLE_LEVELS:
        raise HTTPException(
            status_code=403,
            detail="Chỉ tài khoản Pro Data mới có thể tạo link giới thiệu.",
        )
