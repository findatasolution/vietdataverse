...
**What it does:**
- ✅ Crawls domestic silver prices (Phu Quy brand) - last 7 days from giabac.vn
- ✅ Crawls domestic gold prices (DOJI HN) - from 24h.com.vn via utils.py
- ✅ Crawls SBV interbank rates - from State Bank of Vietnam API
- ✅ Crawls ACB term deposit rates - from acb.com.vn
...
## 🚫 Failed Experiments (Browser Automation)

### **crawl_banks_selenium.py**
**Purpose:** Selenium-based crawler for 6 banks

**Status:** ❌ FAILED - ChromeDriver crashes
...
**Status:** ❌ FAILED - Pages don't load tables
...
**Status:** ❌ FAILED - No content loaded
**Do not use**
...
|--------|-------------|---------|
| **crawl_bot.py** | ⭐ **Daily (GitHub Actions)** | Production crawler |
