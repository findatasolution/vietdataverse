...
- [x] **2026-09-14: Hai luồng crawl SJC độc lập + siết lại tiêu chí "chạy thành công".** Sau khi dọn DB chỉ còn SJC, dựng lại pipeline từ đầu.
  ...
  - **Chạy lần đầu đã tìm ra thiệt hại còn sót:** khoảng 29/6–12/8 (phần freeze mà đợt sửa 13/9 **chưa đụng tới** — đợt đó chỉ làm từ 13/8) có **16 ngày `stale`, 1 `carry_forward`, 5 `unconfirmed`, 1 `fabricated`** (14/07 lưu 144.1/147.1 — SJC ngày đó chỉ đổi 1 lần lúc 18:35 sang 144.5/147.5, và 13/07 đóng ở 145.4/148.4; con số này chưa từng là giá SJC). **Chưa sửa** — cần anh quyết có sửa hay để nguyên.
