...
- `fe/pages/pricing-journey.js`: consumption of server plan facts and contextual comparison. Existing plan IDs, billing amounts, student discount and access enforcement are unchanged.
